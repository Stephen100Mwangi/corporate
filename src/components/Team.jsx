...
const Team = () => {
  return (
    <div className='mx-8 my-24 grid grid-cols-3 gap-16 px-0 rounded-xl justify-start items-center relative max-sm:flex max-sm:flex-col'>
      <div className='relative flex justify-center items-center'>
        <img src="./ceo.png" alt="" className='' />
